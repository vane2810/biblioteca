...
COPY public.autores (id, created_at, updated_at) FROM stdin;
\.
...
COPY public.categorias (id, created_at, updated_at) FROM stdin;
\.
...
COPY public.editoriales (id, created_at, updated_at) FROM stdin;
\.
...
4	2024_05_06_032657_create_categorias	2
5	2024_05_06_032814_create_autores	2
6	2024_05_06_032856_create_recursos	2
7	2024_05_06_033053_create_editoriales	2
\.
...
COPY public.recursos (id, created_at, updated_at) FROM stdin;
\.
